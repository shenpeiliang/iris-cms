...
CREATE TABLE IF NOT EXISTS `hs_article` (
  `id` int NOT NULL DEFAULT '0' COMMENT 'ID编号',
...
CREATE TABLE IF NOT EXISTS `hs_user` (
  ...
  `dateline` int NOT NULL DEFAULT '0' COMMENT '修改时间',
  `is_show` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否审核',
  PRIMARY KEY (`id`),
